...
// Plasmic Project: rWRZsw9VYF316EvQRX6JwD
// Component: tjBXR0jQnC5a
...
import projectcss from "./plasmic.module.css"; // plasmic-import: rWRZsw9VYF316EvQRX6JwD/projectcss
import sty from "./PlasmicPageLayout.module.css"; // plasmic-import: tjBXR0jQnC5a/css

import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: V2w57el4ppb2/icon
import Icon2Icon from "./icons/PlasmicIcon__Icon2"; // plasmic-import: 85t1mt6BphDF/icon
...
function PlasmicPageLayout__RenderFunc(props: {
  ...
  return (
    <RichLayout
      ...
      logoElement={
        <Icon2Icon
          className={classNames(projectcss.all, sty.svg___1OUyf)}
          role={"img"}
        />
      }
      navMenuItems={(() => {
    ...
    >
      <LoadingBoundary
        ...
        loadingState={
          <DataCtxReader__>
            {$ctx => (
              <div className={classNames(projectcss.all, sty.freeBox___8NRgM)}>
                <IconIcon
                  className={classNames(projectcss.all, sty.svg__lh16P)}
                  role={"img"}
                />
              </div>
            )}
      ...
      >
        <DataCtxReader__>
          {$ctx => (
            <div className={classNames(projectcss.all, sty.freeBox__bkE6A)}>
              {renderPlasmicSlot({
                defaultContents: (
                  <section
                    className={classNames(projectcss.all, sty.section__re4Xm)}
                  >
                    <h1
                      className={classNames(
                        projectcss.all,
